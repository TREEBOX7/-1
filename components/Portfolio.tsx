    ...
    <>
      ...
      {selectedProject && (
        ...
        >
          ...
          >
            {/* 왼쪽: 이미지 영역 (여러 장이 아래로 나열됨) */}
            <div className="md:w-2/3 space-y-6 overflow-y-auto max-h-[80vh] pr-2 custom-scrollbar">
            ...
            {/* 오른쪽: 텍스트 정보 영역 (고정) */}
            <div className="md:w-1/3 flex flex-col justify-start pt-10 space-y-6">
              <div>
