...
export const INITIAL_PORTFOLIO: PortfolioItem[] = [
  {
    ...
    "category": "Exterior",
    "description": "도면으로 건물과 사이트를 모델링화 하여 지속 가능한 콘크리트 와 저층 주변상가들과 어울리는 공동주택 AI건축CG 입니다.",
  ...
  },
  {
    ...
    "category": "Exterior",
    "description": "건축가의 도면으로 형태를 유지하면서 대리석과 유리골조로 만들어지면서 낮과 밤을 표현한 사옥 AI건축CG 입니다.",
  ...
  },
  {
    ...
    "category": "Exterior",
    "description": "최고의 사이트를 가상의 공간에서 표현하여 개발을 위한 AI이미지 입니다.",
  ...
  {
    "id": "6",
    "title": "A Library with a Soul Model",
    "category": "Interior",
    "description": "건축가의 머릿속에 있는 가상의 공간으로 건축을 내부를 보여주기 위한 최고의 AI실내CG 입니다.",
    "images": ["/test-5.jpg"],
    "role": "Interior Visualization",
    "contribution": 100,
    "result": "Interior Design Award"
